...
public class Main1 {
    ...
    // Metodo che stampa perimetro e area di un rettangolo passato come parametro.
    ...
    // Metodo che stampa perimetro e area di due rettangoli e ne calcola la somma di aree e perimetri.
